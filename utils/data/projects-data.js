...
export const projectsData = [
    ...
    },
    {
        id: 6,
        name: 'Rubix Cube',
        description: "A simple rubix cube simulator made using javascript and Three.js. It allows you to rotate the cube and see the rotations in 3D. The cube can be rotated in any direction and the rotations are smooth. The cube is also responsive and works on mobile devices.",
        tools: ['Javascript', 'Three.js'],
        code: 'https://github.com/PrashantGyawali/Rubix-Cube',
        demo: 'https://prashantgyawali.github.io/Rubix-Cube/',
